    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          ...
          <span>Info Employying</span>
        </a>
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Info Employying</h6>
            <a class="collapse-item" href="/karyawan">Data Karyawan</a>
            <a class="collapse-item" href="/detail">Lihat detail gaji</a>
          </div>
        </div>
      </li>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="/ambil">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Pengambilan gaji</span></a>
      </li>
...
<li class="nav-item active">
  <a class="nav-link" href="/create">
    <i class="fas fa-fw fa-chart-area"></i>
    <span>Input Detail Karyawan</span></a>
</li>
<li class="nav-item">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ Auth::user()->name}}</span>
                <img class="img-profile rounded-circle" src={{("/img/profile.jpeg")}}>
              </a>
...
<div>
          ...
          <div class="card shadow mb-4">
           ...
           <div>
             <form action="{{route('post_pegawai')}}" method="post">
               @csrf
           <div class="form-group">
  <div><label>Nama Karyawan</label></div>
  <div><input type="text" name="nama" class="form-control" required="required" autocomplete="off" placeholder="">
</div>    </div>
  <div class="form-group">
  <label>No HP</label>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                @foreach($karyawans  as $key=> $result)
                <tr>
                  <td>{{$key+1}}</td>
                  <td>{{$result->id}}</td>
                  ...
                  <td>{{$result->alamat}}</td>
                  <td>{{$result->hp}}</td>
                  <td>{{$result->jabatans->nama_jabatan}}</td>
                  <td>{{$result->lembur->jam_lembur}}</td>
                  <td>{{$result->tunjangans->nama_tunjangan}}</td>
                  <td>{{$result->status->nama_status}}</td>
                  <td>{{$result->absen}}</td>
                  <td><a href="/create/edit/{{$result->id}}" class="btn btn-info" title="edit">Edit</a>
                  <a href="{{route('hapus',$result)}}" class="btn btn-danger" title="hapus" onclick="confirm'yakin ingin menghapus{{$result->nama_karyawan}}">hapus</a></td>
